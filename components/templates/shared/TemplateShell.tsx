export function TemplateShell({
  ...
  return (
    <section className="space-y-6">
      <header className="rounded-xl border border-slate-200 bg-white p-5 shadow-xs dark:border-slate-800 dark:bg-slate-900">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <article className="rounded-xl border border-slate-200 bg-white p-5 shadow-xs dark:border-slate-800 dark:bg-slate-900">{children}</article>
        <article className="rounded-xl border border-slate-200 bg-chart-paper p-5 shadow-xs dark:border-slate-800 dark:bg-slate-950">
