...
> Archived August 2026. Completed work is retained below; the remaining item
> is tracked in [`docs/clinical-review.md`](../clinical-review.md).

## Adult Hygiene 2021 periodontal classification redesign

Source:
[ClearDent Custom Fields and Periodontal Redesign](../requests/archive/ClearDent%20Custom%20Fields%20and%20Periodontal%20Redesign.md)
