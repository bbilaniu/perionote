...
| A10 | `Calculus- NO/YES (If yes where-)`         | Not documented / No / Yes; Yes reveals the same faceted Calculus control as 2021 Adult Hygiene | appCore + patient-specific | `Calculus: No.` or Adult Hygiene Calculus wording; omitted when not documented |
